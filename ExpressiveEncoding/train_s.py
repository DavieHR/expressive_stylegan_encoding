...
def expressive_encoding_pipeline(
    ...
    stage_two_path = os.path.join(save_path, "pose_speed")
    stage_three_path = os.path.join(save_path, "facial_speed")
    stage_four_path = os.path.join(save_path, "pti_speed")
    expressive_param_path = os.path.join(save_path, "expressive_speed")
    ...
    cache_path = '/data1/chenlong/0517/video/0522/kanghui_0/results/man3_chenl_0521/cache.pt'
    ...
    for ii, _file in enumerate(pbar):
        ...
        print(f"1. get face info运行时间：{elapsed_time}秒")
        ...
        stage_two_path = '/data1/chenlong/0517/video/0522/kanghui_0/results/man3_chenl_0521/pose'
