...
from ExpressiveEncoding.train import pivot_finetuning, StyleSpaceDecoder, \
                                 ...
                                 logger,pipeline_init,get_pose_pipeline_batch_2_and_1,get_facial_pipeline_batch_2
...
def get_attribute_multi(
    ...
    multiprocessing.spawn(get_facial_pipeline_batch_2, nprocs=facial_n_workers,
